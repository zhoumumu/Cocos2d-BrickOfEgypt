...
void MenuScene::startMenuCallback(cocos2d::Ref * pSender) {
	SimpleAudioEngine::getInstance()->playEffect("click.mp3", false);
...
void MenuScene::helpCallback(cocos2d::Ref * pSender) {
	SimpleAudioEngine::getInstance()->playEffect("click.mp3", false);
	cover = ui::ScrollView::create();
	cover->setBackGroundColorType(ui::LayoutBackGroundColorType::SOLID);
	cover->setBackGroundColor(Color3B(0, 0, 0));
	cover->setContentSize(visibleSize);
	cover->setAnchorPoint(Vec2(0.5, 0.5));
	cover->setPosition(Vec2(origin.x + visibleSize.width / 2, origin.y + visibleSize.height / 2));
	addChild(cover, 2);

	scrollView = ui::ScrollView::create();
	auto bg = Sprite::create("queen.png");
	bg->setPosition(Vec2(visibleSize.width / 2 + origin.x, visibleSize.height + origin.y));
	bg->setScale(visibleSize.width / bg->getContentSize().width, 2 * visibleSize.height / bg->getContentSize().height);
...
void MenuScene::addText() {
	...
	text->setPosition(Vec2(origin.x + visibleSize.width / 2, origin.y + visibleSize.height*2 - 4*40));
	scrollView->addChild(text);
	auto text1 = ui::Text::create("there's the cure which can make me evergreen", "fonts/arial.ttf", 30);
	text1->setPosition(Vec2(origin.x + visibleSize.width / 2, origin.y + visibleSize.height*2 - 5*40));
	scrollView->addChild(text1);
	auto text2 = ui::Text::create("buried deeply in the most dangerous pyramid", "fonts/arial.ttf", 30);
	text2->setPosition(Vec2(origin.x + visibleSize.width / 2, origin.y + visibleSize.height*2 - 6*40));
	scrollView->addChild(text2);
	auto text3 = ui::Text::create("Once you get there", "fonts/arial.ttf", 30);
	text3->setPosition(Vec2(origin.x + visibleSize.width / 2, origin.y + visibleSize.height * 2 - 7 * 40));
	scrollView->addChild(text3);
	auto text4 = ui::Text::create("you'd better keep your ball away from the ground", "fonts/arial.ttf", 30);
	text4->setPosition(Vec2(origin.x + visibleSize.width / 2, origin.y + visibleSize.height * 2 - 8 * 40));
	scrollView->addChild(text4);
	auto text5 = ui::Text::create("by moving your board to catch it", "fonts/arial.ttf", 30);
	text5->setPosition(Vec2(origin.x + visibleSize.width / 2, origin.y + visibleSize.height * 2 - 9 * 40));
	...
	text6->setPosition(Vec2(origin.x + visibleSize.width / 2, origin.y + visibleSize.height * 2 - 10 * 40));
	scrollView->addChild(text6);
	auto text7 = ui::Text::create("It's better to focus on the ball", "fonts/arial.ttf", 30);
	text7->setPosition(Vec2(origin.x + visibleSize.width / 2, origin.y + visibleSize.height * 2 - 11 * 40));
	scrollView->addChild(text7);
	auto text8 = ui::Text::create("to judge and predict its track", "fonts/arial.ttf", 30);
	text8->setPosition(Vec2(origin.x + visibleSize.width / 2, origin.y + visibleSize.height * 2 - 12 * 40));
	scrollView->addChild(text8);
	auto text9 = ui::Text::create("The good news is that", "fonts/arial.ttf", 30);
	text9->setPosition(Vec2(origin.x + visibleSize.width / 2, origin.y + visibleSize.height * 2 - 13 * 40));
	scrollView->addChild(text9);
	auto text10 = ui::Text::create("you can have a practice", "fonts/arial.ttf", 30);
	text10->setPosition(Vec2(origin.x + visibleSize.width / 2, origin.y + visibleSize.height * 2 - 14 * 40));
	scrollView->addChild(text10);
	auto text11 = ui::Text::create("by choosing \"options\" in a endless mode", "fonts/arial.ttf", 30);
	text11->setPosition(Vec2(origin.x + visibleSize.width / 2, origin.y + visibleSize.height * 2 - 15 * 40));
	scrollView->addChild(text11);
	auto text12 = ui::Text::create("Take it slow", "fonts/arial.ttf", 30);
	text12->setPosition(Vec2(origin.x + visibleSize.width / 2, origin.y + visibleSize.height * 2 - 16 * 40));
	scrollView->addChild(text12);
	auto text13 = ui::Text::create("And take care", "fonts/arial.ttf", 30);
	text13->setPosition(Vec2(origin.x + visibleSize.width / 2, origin.y + visibleSize.height * 2 - 17 * 40));
	scrollView->addChild(text13);
	auto text14 = ui::Text::create("\nGood luck, my warrior!", "fonts/arial.ttf", 30);
	text14->setPosition(Vec2(origin.x + visibleSize.width / 2, origin.y + visibleSize.height * 2 - 18.5 * 40));
	scrollView->addChild(text14);

	auto back = MenuItemFont::create("Back", CC_CALLBACK_1(MenuScene::backCallback, this));
	back->setFontName("fonts/Marker Felt.ttf");
	back->setFontSize(40);
	back->setPosition(Vec2(origin.x + visibleSize.width / 2 + 150, origin.y + visibleSize.height * 2 - 21 * 40));
